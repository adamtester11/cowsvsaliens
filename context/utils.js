...
/**
 * @dev it creates payload for the metamask transaction and send it to metamask for user signature
 */
export const sendTransaction = async (from, to, value, provider = {}) => {
  if (!from || !to || !value) {
    throw new Error("From, to and value must be provided");
  }
